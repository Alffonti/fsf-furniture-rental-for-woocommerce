...
class WC_Product_phive_booking extends WC_Product {
	...
	public function get_price($context = 'view'){
		...
		$final_price = apply_filters('phive_booking_cost',$price,$this->id);
	...
	public function add_to_cart_text() {
		...
		/*if ( $this->is_purchasable() && $this->is_in_stock() ) {
			$text = get_option( WC_bookings_Admin::$option_prefix . '_add_to_cart_button_text', __( 'Sign Up Now', 'furniture-rental-for-woocommerce' ) );
		} else {
			$text = parent::add_to_cart_text(); // translated "Read More"
		}*/

		$text = __('Add to package','furniture-rental-for-woocommerce');
